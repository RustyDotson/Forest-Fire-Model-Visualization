The main branch is currently being built using a custom MakeFile that works on my local machine. Please clone the cmake branch for better compatibility. AI is good for learning but often walks you through really bad ways of doing things :/
